...
export const routes = {
  ...
  accounts: { root: '/accounts', byId: (id: string) => `/accounts/${id}`, archive: (id: string) => `/accounts/${id}/archive`, restore: (id: string) => `/accounts/${id}/restore` },
  creditCards: { root: '/credit-cards', byId: (id: string) => `/credit-cards/${id}`, archive: (id: string) => `/credit-cards/${id}/archive`, restore: (id: string) => `/credit-cards/${id}/restore` },
  categories: { root: '/categories', byId: (id: string) => `/categories/${id}`, archive: (id: string) => `/categories/${id}/archive`, restore: (id: string) => `/categories/${id}/restore` },
  transactions: {
    root: '/transactions',
  ...
  imports: { preview: '/imports/preview', confirm: (batchId: string) => `/imports/${batchId}/confirm`, batch: (batchId: string) => `/imports/${batchId}`, history: '/imports' },
